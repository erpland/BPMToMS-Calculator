...
namespace bpmtomstest1
{
...

    {
        ...
        private void calculation_method()
        {
            if (bpmTB.Text == "")
            {
                bpmInput = 0;
        ...
        private void resLBL4DoubleClick(object sender, EventArgs e)
        {
            logMsg.Text = "|  Copied!";
            timerText.Enabled = true;
        }

        private void resLBL8DoubleClick(object sender, EventArgs e)
        {
            logMsg.Text = "|  Copied!";
            timerText.Enabled = true;
        }

        private void resLBL16_DoubleClick(object sender, EventArgs e)
        {
            logMsg.Text = "|  Copied!";
            timerText.Enabled = true;
        }
